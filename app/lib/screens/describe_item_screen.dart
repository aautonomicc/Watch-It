...
class _DescribeItemScreenState extends State<DescribeItemScreen> {
  ...
  Future<void> _save() async {
    ...
    // No category here on purpose (absent = the row keeps whatever a
    // TMDB match stored locally): channels don't publish category tags
    // — the manifest build nulls them out and channel list pages show
    // no genre chips.
